...
module.exports = function (core) {
    ...
    return router
        ...
        .get('/:model', function (req, res, next) {

            var page = req.query.page ? parseInt(req.query.page) - 1 : 0;
            var per_page = req.query.per_page ? parseInt(req.query.per_page) : (core.config['default_per_page'] || 50);
        ...
        .get('/:model/:id([0-9a-fA-F]{24})', function (req, res, next) {
        ...
        .post('/:model', function (req, res, next) {

            req.model.create(req.body).then(res.send.bind(res)).catch(next);

        })

        .put('/:model/:id([0-9a-fA-F]{24})', function (req, res, next) {
        ...
        .delete('/:model/:id([0-9a-fA-F]{24})', function (req, res, next) {
